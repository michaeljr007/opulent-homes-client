...
import user1 from "./img/marie.jpg";
import user2 from "./img/team-1.jpg";
import user3 from "./img/team-2.jpg";
          ...
          <table className="w-[95vw] lg:w-full">
            <thead>
              <tr className="border-b border-gray-300">
                <th className="py-1 lg:py-2 text-left pl-4 pr-5">Staff</th>
